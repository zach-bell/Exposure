...
namespace Exposure.Utilities.Procedural {
	...
	public static class Noise {
		...
		Perlin1D, Perlin2D, Perlin3D
	};

		public static NoiseMethod[][] NoiseMethods = {
		valueMethods, perlinMethods
	};
		...
		/*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*
		 *																					*
		 *								Perlin Noise Starts here							*
		 *																					*
		 *	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*	*/

		private static float Perlin1D(Vector3 point, float frequency) {
			point *= frequency;
			int i0 = Mathf.FloorToInt(point.x);
			float t0 = point.x - i0;
			float t1 = t0 - 1f;
		...
		private static float Perlin2D(Vector3 point, float frequency) {
			point *= frequency;
			int ix0 = Mathf.FloorToInt(point.x);
			int iy0 = Mathf.FloorToInt(point.y);
		...
		private static float Perlin3D(Vector3 point, float frequency) {
			point *= frequency;
			int ix0 = Mathf.FloorToInt(point.x);
			int iy0 = Mathf.FloorToInt(point.y);
			int iz0 = Mathf.FloorToInt(point.z);
